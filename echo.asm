...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++)
    ...
    1038:	68 b8 17 00 00       	push   $0x17b8
    103d:	83 c3 04             	add    $0x4,%ebx
    1040:	50                   	push   %eax
    1041:	68 ba 17 00 00       	push   $0x17ba
    1046:	6a 01                	push   $0x1
  ...
  for(i = 1; i < argc; i++)
    ...
    1057:	68 bf 17 00 00       	push   $0x17bf
    105c:	50                   	push   %eax
    105d:	68 ba 17 00 00       	push   $0x17ba
    1062:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15d4:	eb 1a                	jmp    15f0 <printf+0x1a0>
          s = "(null)";
    15d6:	bb c1 17 00 00       	mov    $0x17c1,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1625:	a1 78 1a 00 00       	mov    0x1a78,%eax
{
    ...
    1646:	73 10                	jae    1658 <free+0x38>
{
  ...
  freep = p;
    ...
    1671:	5b                   	pop    %ebx
  freep = p;
    1672:	a3 78 1a 00 00       	mov    %eax,0x1a78
}
    1677:	5e                   	pop    %esi
    1678:	5f                   	pop    %edi
    1679:	5d                   	pop    %ebp
  ...
  freep = p;
    169a:	a3 78 1a 00 00       	mov    %eax,0x1a78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16c0:	8b 3d 78 1a 00 00    	mov    0x1a78,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1709:	8b 3d 78 1a 00 00    	mov    0x1a78,%edi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
  ...
  return freep;
    1737:	a1 78 1a 00 00       	mov    0x1a78,%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1767:	a3 78 1a 00 00       	mov    %eax,0x1a78
}
    ...
    base.s.ptr = freep = prevp = &base;
    1780:	c7 05 78 1a 00 00 7c 	movl   $0x1a7c,0x1a78
    1787:	1a 00 00 
    base.s.size = 0;
    178a:	bf 7c 1a 00 00       	mov    $0x1a7c,%edi
    base.s.ptr = freep = prevp = &base;
    178f:	c7 05 7c 1a 00 00 7c 	movl   $0x1a7c,0x1a7c
    1796:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    179b:	c7 05 80 1a 00 00 00 	movl   $0x0,0x1a80
    17a2:	00 00 00 
    if(p->s.size >= nunits){
