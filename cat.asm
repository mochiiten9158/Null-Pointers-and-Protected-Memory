...
00001090 <cat>:
{
  ...
  if(n < 0){
    ...
    10df:	68 48 18 00 00       	push   $0x1848
    10e4:	6a 01                	push   $0x1
    ...
    10f0:	50                   	push   %eax
    10f1:	50                   	push   %eax
    10f2:	68 5a 18 00 00       	push   $0x185a
    10f7:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1664:	eb 1a                	jmp    1680 <printf+0x1a0>
          s = "(null)";
    1666:	bb 80 18 00 00       	mov    $0x1880,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    16b5:	a1 80 1b 00 00       	mov    0x1b80,%eax
{
    ...
    16d6:	73 10                	jae    16e8 <free+0x38>
{
  ...
  freep = p;
    172a:	a3 80 1b 00 00       	mov    %eax,0x1b80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1750:	8b 3d 80 1b 00 00    	mov    0x1b80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
